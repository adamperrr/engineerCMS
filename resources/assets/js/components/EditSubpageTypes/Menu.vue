<template>
    <div>
        ...
        <table class="table table-hover">
            ...
            <tr>
                <td colspan="5">
                    <button type="button" class="form-control" v-on:click.prevent="fetchSubpages()">
                        <span class="glyphicon glyphicon-refresh"></span>
                        Załaduj linki podstron
                    </button>
                </td>
            </tr>
            <tr>
...
<script>
    export default {
        ...
        methods: {
            fetchLinks() {
                this.links = JSON.parse(this.subpage.content);
            },
            fetchSubpages() {
